...
namespace Com.IsartDigital.Utils.Effects
{
    ...
    public partial class Shaker : Node
	{
        ...
        public void Start() 
        {
            ...
            for (int i = 0;i<lCount;i++) origins.Add((Vector2)targets[i].Get("global_position"));
        ...
        public void Stop() {
            ...
            for (int i = 0; i < lLength; i++)
            {
                targets[i].Set("global_position", origins[i]);
            }
        ...
        public void Loop() {
            ...
            for (int i = 0; i < lCount; i++)
            {
                ...
                loop.TweenProperty(targets[i], "global_position", origins[i] + lNext*intensity, step);
